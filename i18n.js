...
const i18n = (() => {
  const dict = {
    ...
    "nav.classes.saebyeol": { ko: "새별반 (1학년)", en: "Saebyeol (G1)" },
    "nav.classes.hanbyul":{ ko: "한별반 (초급)",   en: "Hanbyul (Beg.)" },
    "nav.classes.raon":    { ko: "라온반 (청소년 입문)", en: "Raon (Youth Beg.)" },
    ...
    "class.saebyeol.name":   { ko: "새별반", en: "Saebyeol" },
    "class.saebyeol.level":  { ko: "1학년", en: "Grade 1" },
    "class.saebyeol.age":    { ko: "6 – 7세", en: "Ages 6–7" },
    "class.saebyeol.goal":   { ko: "한글 첫 읽기와 쓰기, 교실 생활 익히기", en: "First reading & writing in Hangul, settling into the classroom" },
    "class.saebyeol.cur1":   { ko: "한글 첫걸음: 자음과 모음 소리 익히고 글자 모아 읽기", en: "First steps in Hangul: letter sounds & blending letters into words" },
    "class.saebyeol.cur2":   { ko: "짧은 낱말 쓰기, 그림책 소리 내어 읽기", en: "Writing short words & reading picture books aloud" },
    ...
    "class.raon.name":       { ko: "라온반", en: "Raon" },
    "class.raon.level":      { ko: "청소년 입문", en: "Youth Beginner" },
    "class.raon.age":        { ko: "11 – 15세", en: "Ages 11–15" },
    "class.raon.goal":       { ko: "한글부터 차근차근 시작, 또래와 함께하는 수업", en: "Starting from Hangul & learning alongside their own age group" },
    "class.raon.cur1":       { ko: "한글 자모와 받침부터 시작하는 읽기·쓰기", en: "Reading and writing, starting from Hangul letters and syllable blocks" },
    "class.raon.cur2":       { ko: "학교·친구·관심사 등 생활 주제로 하는 말하기 연습", en: "Speaking practice on everyday topics — school, friends, and interests" },
    ...
    // ── Saebyeol detail ─────────────────────────────
    "saebyeol.hero.desc":       { ko: "한글 첫 글자와 낱말을 만나는 초등 1학년 반.", en: "Meeting the first Hangul letters and words in Grade 1." },
    "saebyeol.hero.age":        { ko: "초등학교 1학년이 되어 한글 읽기와 쓰기를 시작하는 학생들을 위한 반입니다.", en: "For Grade 1 children who are starting to read and write Hangul." },
    "saebyeol.overview.title":  { ko: "반 소개", en: "Class Overview" },
    "saebyeol.overview":        { ko: "새별반은 <strong>한국어를 이제 글자로 만나기 시작하는</strong> 아이들을 위한 반입니다. 주중에는 학교에서 영어로 지내는 시기라, 토요일에는 <strong>자음과 모음, 자기 이름, 짧은 낱말</strong>부터 천천히 익혀 갑니다. 앉아서 연필을 잡는 시간이 조금씩 길어지지만, <strong>노래와 놀이도 여전히 함께 있습니다</strong>. <strong>한글을 아직 몰라도 괜찮습니다</strong> — 여기서 처음 시작하면 됩니다.", en: "Saebyeol Class is for children who are <strong>now meeting Korean as letters on a page</strong>. Their school week runs in English, so Saturdays start gently with <strong>the consonants and vowels, their own names, and short familiar words</strong>. Sitting and holding a pencil takes up a little more of the morning now, but <strong>songs and play are still part of every class</strong>. <strong>Children do not need to know any Hangul yet</strong> — this is where they start." },
    "saebyeol.focus.title":     { ko: "학습 중점", en: "Learning Focus" },
    "saebyeol.focus.1":         { ko: "자음과 모음의 소리 익히기", en: "Consonant and vowel sounds" },
    "saebyeol.focus.2":         { ko: "글자를 모아 낱말 읽기", en: "Blending letters into words" },
    "saebyeol.focus.3":         { ko: "연필 잡기와 또박또박 쓰기", en: "Pencil grip and careful letter formation" },
    "saebyeol.focus.4":         { ko: "교실에서 쓰는 한국어 표현", en: "Everyday classroom Korean" },
    "saebyeol.focus.5":         { ko: "짧은 문장 듣고 말하기", en: "Listening and speaking in short sentences" },
    "saebyeol.activities.title": { ko: "주요 학습 활동", en: "Sample Learning Activities" },
    "saebyeol.act.1":           { ko: "글자 카드로 자음·모음 익히기", en: "Letter and sound card games" },
    "saebyeol.act.2":           { ko: "이름 쓰기와 이름표 만들기", en: "Writing their name and making a name tag" },
    "saebyeol.act.3":           { ko: "그림책 함께 읽고 아는 낱말 찾기", en: "Reading picture books together and spotting familiar words" },
    "saebyeol.act.4":           { ko: "글자 따라 쓰기와 낱말 옮겨 쓰기", en: "Tracing letters and copying short words" },
    "saebyeol.act.5":           { ko: "동요와 챈트로 글자 소리 익히기", en: "Learning letter sounds through songs and chants" },
    "saebyeol.act.6":           { ko: "계절과 명절 이야기 나누기", en: "Talking about seasons and Korean holidays" },
    "saebyeol.atmosphere.title": { ko: "수업 분위기", en: "Teaching Approach" },
    "saebyeol.atmosphere":      { ko: "새별반 교실은 조용하지만 딱딱하지 않습니다. 글씨가 삐뚤어도 괜찮고, 틀리면 다시 써 보면 됩니다. 아이마다 속도가 다르니, 아직 어려운 아이 옆에는 선생님이 한 번 더 앉습니다.", en: "The Saebyeol classroom is calm, but not stiff. Crooked handwriting is fine, and a mistake just means writing it once more. Children reach this stage at different speeds, so the teacher sits down again beside the ones who need another try." },
    "saebyeol.practical.note":  { ko: "수업 시간과 등록금에 대한 안내는 확정 후 공지됩니다.", en: "Class times and tuition will be posted once confirmed." },
    ...
    // ── Raon detail ─────────────────────────────
    "raon.hero.desc":           { ko: "나이에 맞는 교실에서 한국어를 처음부터 시작하는 반.", en: "Starting Korean from the beginning in a classroom that fits their age." },
    "raon.hero.age":            { ko: "영어가 더 편하고 한국어는 이제 시작하는 중·고등 연령 학생들을 위한 반입니다.", en: "For secondary students who are more comfortable in English and are starting Korean now." },
    "raon.overview.title":      { ko: "반 소개", en: "Class Overview" },
    "raon.overview":            { ko: "라온반은 <strong>한국어를 이제 시작하는 청소년 친구들</strong>을 위한 반입니다. 배우는 내용은 <strong>한글과 기초 표현부터</strong> 시작하지만, 함께 읽는 글과 이야기 나누는 주제는 <strong>나이에 맞춰</strong> 고릅니다. 집에서 한국어를 조금 알아듣는 학생도, 거의 처음인 학생도 <strong>같은 교실에서 함께</strong> 배웁니다. 이 나이에 한국어를 시작하는 건 <strong>여기서 흔한 일</strong>이고, 그렇게 시작한 친구들과 한 학기씩 쌓아갑니다.", en: "Raon Class is for <strong>teen students who are starting Korean now</strong>. The material begins with <strong>Hangul and everyday phrases</strong>, while the texts they read and the things they talk about are <strong>chosen for their age</strong>. Students who understand a little Korean at home and students starting with almost none learn <strong>side by side</strong>. Starting Korean at this age is <strong>ordinary here</strong>, and students build term by term alongside classmates who started the same way." },
    "raon.focus.title":         { ko: "학습 중점", en: "Learning Focus" },
    "raon.focus.1":             { ko: "한글 읽기와 쓰기", en: "Reading and writing Hangul" },
    "raon.focus.2":             { ko: "일상에서 쓰는 어휘와 표현", en: "Everyday vocabulary and expressions" },
    "raon.focus.3":             { ko: "문장 만들기와 기본 문법", en: "Sentence building and core grammar" },
    "raon.focus.4":             { ko: "듣고 이해하는 힘", en: "Listening and understanding" },
    "raon.focus.5":             { ko: "말해 보고 질문하는 자신감", en: "Confidence to speak up and ask" },
    "raon.activities.title":    { ko: "주요 학습 활동", en: "Sample Learning Activities" },
    "raon.act.1":               { ko: "한글 글자와 소리 익히기", en: "Hangul letters and sounds" },
    "raon.act.2":               { ko: "낱말 쓰기에서 문장 쓰기로", en: "From writing words to writing sentences" },
    "raon.act.3":               { ko: "짧은 글 읽고 생각 나누기", en: "Reading short texts and sharing thoughts" },
    "raon.act.4":               { ko: "상황별 짧은 대화 연습", en: "Short conversation practice" },
    "raon.act.5":               { ko: "관심 있는 주제로 어휘 늘리기", en: "Building vocabulary around topics they choose" },
    "raon.act.6":               { ko: "노래와 영상, 웹툰으로 듣고 읽기", en: "Listening and reading with songs, videos, and webtoons" },
    "raon.atmosphere.title":    { ko: "수업 분위기", en: "Teaching Approach" },
    "raon.atmosphere":          { ko: "라온반은 학생을 나이에 맞게 대하는 교실입니다. 수업 자료는 이 또래에 맞춰 따로 고르고, 진도는 학생들의 속도에 맞춥니다. 한 번 더 확인하고 넘어가도 아무도 신경 쓰지 않습니다.", en: "Raon Class is a classroom that meets students at their age. Materials are chosen for this age group, and the pace follows the students. No one takes any notice when someone needs to go over something a second time." },
    "raon.practical.note":      { ko: "수업 일정과 등록금에 대한 최종 안내는 확정 후 공지됩니다.", en: "Final schedule and tuition details will be posted once confirmed." },
    ...
    "gaon.overview":           { ko: "가온반은 <strong>청소년 친구들이 부담 없이 한국어를 이어가는 반</strong>입니다. 친구들과 함께 <strong>읽고, 쓰고, 이야기 나누며</strong> 한국어와 한국 문화에 <strong>자연스럽게 가까워질 수 있도록</strong> 돕습니다. <strong>잘하든 처음이든, 누구나 편하게</strong> 시작할 수 있는 반입니다.", en: "Gaon Class is a <strong>relaxed space for teen learners</strong> who want to keep growing in Korean. Together we <strong>read, write, and talk</strong>, getting more comfortable with Korean language and culture along the way. <strong>Whether confident or just starting</strong>, everyone is welcome." },
    ...
    "goeup.overview":          { ko: "고급반은 한국어를 <strong>좀 더 깊이 있게 이어가고 싶은 고등 연령 친구들</strong>을 위한 반입니다. 함께 <strong>글을 읽고 쓰고</strong>, <strong>한국 문화와 역사에 대해 이야기 나누며</strong>, <strong>자신만의 표현</strong>을 키워갑니다. <strong>잘해야 한다는 부담 없이</strong>, 편안한 분위기에서 함께 배워가는 반입니다.", en: "Goeup Class is for <strong>older students who want to keep building their Korean</strong> a little further. We <strong>read, write, and talk about Korean culture and history</strong> together, helping students <strong>find their own voice</strong>. <strong>No pressure to be 'advanced'</strong> — just a comfortable space to keep growing." },
