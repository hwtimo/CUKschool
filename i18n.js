...
const i18n = (() => {
  const dict = {
    ...
    "danbi.overview":        { ko: "단비반은 한국어를 처음 배우기 시작하는 어린 학생들을 위한 반입니다. 노래, 이야기, 신체 활동, 놀이, 그리고 반복적인 교실 루틴을 통해 아이들이 한국어를 자연스럽게 듣고 말하는 데 익숙해질 수 있도록 돕습니다. 따뜻하고 체계적이며 격려하는 환경 속에서 한국어에 대한 좋은 첫 경험을 쌓는 데 중점을 둡니다.", en: "Danbi Class is designed for young learners who are beginning their Korean language journey. Through songs, stories, movement, play, and classroom routines, students build comfort with listening to and using Korean in a natural way. The class focuses on creating a positive first experience with Korean in a warm, structured, and encouraging environment." },
    ...
    "hanbyeol.overview":       { ko: "한별반은 한국어에 대한 초기 노출 단계를 넘어, 보다 체계적인 연습을 통해 실력을 키워가고자 하는 학생들을 위한 반입니다. 상호작용 중심의 활동, 지도형 학습, 그리고 일관된 수업 루틴을 통해 말하기, 듣기, 초기 읽기, 참여 능력을 함께 기릅니다.", en: "Hanbyeol Class is designed for students who are ready to grow beyond early exposure and build stronger Korean skills through structured practice. The class supports speaking, listening, early reading, and participation through interactive activities, guided learning, and consistent classroom routines." },
    ...
    "gaon.overview":           { ko: "가온반은 보다 높은 수준의 한국어 학습이 가능한 중·고등 연령의 학생들을 위한 반입니다. 읽기, 쓰기, 이해, 자기표현 능력을 강화하는 데 중점을 두며, 한국어와 한국 문화를 보다 깊이 있게 이해할 수 있도록 돕습니다.", en: "Gaon Class is designed for older students who are ready for more advanced Korean learning. The class focuses on building stronger reading, writing, comprehension, and self-expression skills while helping students engage more deeply with Korean language and culture." },
    ...
    "goeup.overview":          { ko: "고급반은 한국어 학습에서 더 높은 수준의 도전을 원하는 고등 연령 학생들을 위한 반입니다. 심화된 읽기와 쓰기, 문화와 역사에 대한 비판적 사고, 그리고 다양한 주제에 걸친 유창한 의사소통 능력을 키우는 데 중점을 둡니다. 학생들이 한국어를 학문적·개인적으로 더 깊이 활용할 수 있도록 준비시키는 것을 목표로 합니다.", en: "Goeup Class is designed for older students who are ready for more advanced challenges in Korean language learning. The class focuses on deepening reading and writing skills, developing critical thinking about Korean culture and history, and building fluent communication across a range of topics." },
